...
type GoogleLoginButtonProps = {
  /** Optional deep-link destination after auth */
  next?: string;
  /** Button label (accessible & visible) */
  label?: string;
  /** Wrapper <form> className */
  className?: string;
  /** <Button> className overrides */
...
export default function GoogleLoginForm({
  ...
  return (
    <form action={signInWithGoogle.bind(null, next)} className={className}>
      <Button
        type="submit"
        aria-label={label}
        className={cn(
